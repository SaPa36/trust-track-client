        ...
        <section className="p-6 border border-dashed border-blue-400 rounded-lg relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 mt-5">
            ...
            <div className="space-y-4">
              ...
              <input {...register("senderName")} placeholder="Sender Name" className="w-full p-2 border border-slate-300 rounded" />
              <select {...register("senderWarehouse")} className="w-full p-2 border border-slate-300 rounded text-slate-400">
                <option value="">Select Wire house</option>
                <option value="dhaka_main">Dhaka Main</option>
              </select>
              <input {...register("senderAddress")} placeholder="Address" className="w-full p-2 border border-slate-300 rounded" />
              <input {...register("senderContact")} placeholder="Sender Contact No" className="w-full p-2 border border-slate-300 rounded" />
              <select {...register("senderRegion")} className="w-full p-2 border border-slate-300 rounded text-slate-400">
                <option value="">Select your region</option>
                <option value="dhaka">Dhaka</option>
              </select>
              <textarea {...register("pickupInstruction")} placeholder="Pickup Instruction" className="w-full p-2 border border-slate-300 rounded h-24" />
            </div>

            {/* Receiver Details */}
            <div className="space-y-4">
              <h3 className="font-bold text-[#002B2B] border-b pb-2">Receiver Details</h3>
              <input {...register("receiverName")} placeholder="Receiver Name" className="w-full p-2 border border-slate-300 rounded" />
              ...
              <input {...register("receiverAddress")} placeholder="Address" className="w-full p-2 border border-slate-300 rounded" />
              <input {...register("receiverContact")} placeholder="Receiver Contact No" className="w-full p-2 border border-slate-300 rounded" />
              <select {...register("receiverRegion")} className="w-full p-2 border border-slate-300 rounded text-slate-400">
                <option value="">Select your region</option>
                <option value="chattogram">Chattogram</option>
              </select>
              <textarea {...register("deliveryInstruction")} placeholder="Delivery Instruction" className="w-full p-2 border border-slate-300 rounded h-24" />
            </div>
          </div>
        </section>
